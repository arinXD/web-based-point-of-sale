	...
	<ul class="flex flex-row justify-between items-center">
		...
		<li>
			<ul class="flex gap-16">
				<li>
					<a class="flex flex-col items-center justify-center" href="/users">
				...
				<li>
					<a class="flex flex-col items-center justify-center" href="/tables">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
				...
				<li>
					<a class="flex flex-col items-center justify-center" href="/menu">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
				...
				<li>
					<a class="flex flex-col items-center justify-center" href="/dashboard">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
				...
				<li>
					<a class="flex flex-col items-center justify-center" href="/history">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
				...
				<li>
					<a href="/logout">
						<button class="gap-2 flex flex-row items-center justify-center border border-1 border-red-400 p-2 rounded-lg bg-red-400 text-black">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
